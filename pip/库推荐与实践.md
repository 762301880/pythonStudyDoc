...
>
> **注意这种方法是吧已经安装的pip 包全写入requirements.txt 文件中了**
...
##  自动写入项目依赖到requirements.txt中

> 有时候我们项目中直接用pip install 安装了但是到了生产环境想一键
>
> 安装依赖 又忘记写requirements.txt怎么办呢 

### 资料

| 名称     | 地址                                      |
| -------- | ----------------------------------------- |
| 官方文档 | [link](https://pypi.org/project/pipreqs/) |
...
# 代码调用
https://gitee.com/yao_liu_yang/linux_shell/raw/master/generate_requirements.py
```
